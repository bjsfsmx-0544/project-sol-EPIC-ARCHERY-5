...
function setup() {
  ...
  // Función para controlar las flechas de la computadora
...
function draw() {
 ...
 // Usar un ciclo for para mostrar las flechas usando la función showArrow()
...
// Llamar las funciones para detectar colisiones para el jugador y la computadora 
...
function keyPressed() {
  ...
  if(keyCode === 32){
    // Crear un objeto flecha y agregarlo al arreglo. Configurar su ángulo igual al ángulo de playerArcher
...
// Mostrar las flechas y la trayectoria 
...
// Escribir el código para detectar colisiones entre la flecha del jugador y el oponente
}

function handleComputerArrowCollision() {
  // Escribir el código para detectar colisiones entre la flecha de la computadora y el oponente
}
